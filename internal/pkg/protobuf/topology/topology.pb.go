...
var file_internal_pkg_protobuf_topology_topology_proto_goTypes = []any{
...
func file_internal_pkg_protobuf_topology_topology_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internal_pkg_protobuf_topology_topology_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_internal_pkg_protobuf_topology_topology_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Socket); i {
			case 0:
				return &v.state
			case 1:
		...
		file_internal_pkg_protobuf_topology_topology_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Core); i {
			case 0:
				return &v.state
			case 1:
		...
		file_internal_pkg_protobuf_topology_topology_proto_msgTypes[3].Exporter = func(v any, i int) any {
