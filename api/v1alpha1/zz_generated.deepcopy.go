...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodCpuCoreBinding) DeepCopyInto(out *PodCpuCoreBinding) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodCpuCoreBinding.
func (in *PodCpuCoreBinding) DeepCopy() *PodCpuCoreBinding {
	if in == nil {
		return nil
	}
	out := new(PodCpuCoreBinding)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *PodCpuCoreBinding) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodCpuCoreBindingList) DeepCopyInto(out *PodCpuCoreBindingList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]PodCpuCoreBinding, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodCpuCoreBindingList.
func (in *PodCpuCoreBindingList) DeepCopy() *PodCpuCoreBindingList {
	if in == nil {
		return nil
	}
	out := new(PodCpuCoreBindingList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *PodCpuCoreBindingList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodCpuCoreBindingSpec) DeepCopyInto(out *PodCpuCoreBindingSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodCpuCoreBindingSpec.
func (in *PodCpuCoreBindingSpec) DeepCopy() *PodCpuCoreBindingSpec {
	if in == nil {
		return nil
	}
	out := new(PodCpuCoreBindingSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodCpuCoreBindingStatus) DeepCopyInto(out *PodCpuCoreBindingStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodCpuCoreBindingStatus.
func (in *PodCpuCoreBindingStatus) DeepCopy() *PodCpuCoreBindingStatus {
	if in == nil {
		return nil
	}
	out := new(PodCpuCoreBindingStatus)
	in.DeepCopyInto(out)
	return out
}
